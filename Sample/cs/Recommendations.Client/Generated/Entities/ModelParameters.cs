...
namespace Recommendations.Client.Entities
{
    ...
    public partial class ModelParameters
    {
        ...
        public ModelParameters(string usageFolderRelativeLocation, string description = default(string), string blobContainerName = default(string), string catalogFileRelativeLocation = default(string), string evaluationUsageFolderRelativeLocation = default(string), int? supportThreshold = default(int?), CooccurrenceUnit? cooccurrenceUnit = default(CooccurrenceUnit?), SimilarityFunction? similarityFunction = default(SimilarityFunction?), bool? enableColdItemPlacement = default(bool?), bool? enableColdToColdRecommendations = default(bool?), bool? enableUserAffinity = default(bool?), bool? allowSeedItemsInRecommendations = default(bool?), bool? enableBackfilling = default(bool?), int? decayPeriodInDays = default(int?))
        {
